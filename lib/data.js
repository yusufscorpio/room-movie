...
export const DEFAULT_CONTENT = [
  ...
  { id: 'fate-of-furious-2017', title: 'The Fate of the Furious', category: 'movies', desc: 'Saat Dom dan Letty menikmati bulan madu, seorang wanita misterius bernama Cipher menggoda Dom ke dunia kejahatan, mengkhianati orang-orang terdekatnya dan memaksa keluarganya menghadapi tantangan yang belum pernah mereka temui.', genres: ['Action','Crime','Thriller'], rating: 6.6, year: 2017, duration: '2:30', quality: 'HD', streams: '1.2B+', image: 'https://image.tmdb.org/t/p/w500/dImWM7GJqryWJO9LHa3XQ8DD5NH.jpg', backdrop: 'https://image.tmdb.org/t/p/original/jzdnh7C0ZAfFOzMeXBjvq3clmRT.jpg', videoType: 'embed', videoSrc: 'https://www.youtube.com/embed/JwMKRevYa_M?vq=hd1080&hd=1&rel=0', tag: 'trending', createdAt: 1747500011000 },
  { id: 'f9-fast-saga-2021', title: 'F9: The Fast Saga', category: 'movies', desc: 'Dom Toretto menjalani hidup tenang bersama Letty dan putranya. Namun ancaman dari masa lalu muncul ketika ia harus berhadapan dengan adiknya sendiri, seorang pembunuh terlatih yang bekerja dengan musuh lama mereka.', genres: ['Action','Adventure','Thriller'], rating: 5.2, year: 2021, duration: '2:35', quality: 'HD', streams: '720M+', image: 'https://image.tmdb.org/t/p/w500/bOFaAXmWWXC3Rbv4u4uM9ZSzRXP.jpg', backdrop: 'https://image.tmdb.org/t/p/original/9xRz5SHkLXdmrnRSwwTuTYn6c2Y.jpg', videoType: 'embed', videoSrc: 'https://www.youtube.com/embed/aSiDu3Ywi8E?vq=hd1080&hd=1&rel=0', tag: 'trending', createdAt: 1747500012000 },
  { id: 'fast-x-2023', title: 'Fast X', category: 'movies', desc: 'Dom Toretto dan keluarganya berhadapan dengan musuh paling mematikan yang pernah mereka temui. Lahir dari bayang-bayang masa lalu, didorong oleh balas dendam, Dante Reyes berusaha menghancurkan keluarga Dom satu per satu.', genres: ['Action','Adventure','Thriller'], rating: 7.0, year: 2023, duration: '3:30', quality: 'HD', streams: '700M+', image: 'https://image.tmdb.org/t/p/w500/fiVW06jE7z9YnO4trhaMEdclSiC.jpg', backdrop: 'https://image.tmdb.org/t/p/original/4XM8DUTQb3lhyemXKlD2NjxwMmH.jpg', videoType: 'embed', videoSrc: 'https://www.youtube.com/embed/DmGqittlssg?vq=hd1080&hd=1&rel=0', tag: 'featured', createdAt: 1747500013000 },
  { id: 'transformers-2007', title: 'Transformers', category: 'movies', desc: 'Dua bangsa robot alien berperang—Autobots yang heroik vs Decepticons yang jahat. Pertempuran mereka tiba di Bumi, dan nasib umat manusia bergantung pada seorang remaja bernama Sam Witwicky.', genres: ['Action','Sci-Fi','Adventure'], rating: 7.0, year: 2007, duration: '2:23', quality: 'HD', streams: '710M+', image: 'https://image.tmdb.org/t/p/w500/1P7w3AImoEOWJX7nn3fdaKDfEQA.jpg', backdrop: 'https://image.tmdb.org/t/p/original/wcTDxW9JEr9cORajaQLrv8ls9Ly.jpg', videoType: 'embed', videoSrc: 'https://www.youtube.com/embed/CbX_SIz_9fk?vq=hd1080&hd=1&rel=0', tag: 'trending', createdAt: 1747500014000 },
  { id: 'transformers-revenge-of-fallen-2009', title: 'Transformers: Revenge of the Fallen', category: 'movies', desc: 'Sam Witwicky pergi ke kuliah, berharap memulai hidup normal. Namun, Decepticons kembali dengan rencana baru yang lebih berbahaya, dan ia harus kembali bersatu dengan Optimus Prime dan Autobots untuk menyelamatkan dunia.', genres: ['Action','Sci-Fi','Adventure'], rating: 6.0, year: 2009, duration: '2:24', quality: 'HD', streams: '836M+', image: 'https://image.tmdb.org/t/p/w500/pLBb0whOzVDtJvyD4DPeQyQNOqp.jpg', backdrop: 'https://image.tmdb.org/t/p/original/bH1bhjn37uA1zOPvyHbzJSvza7v.jpg', videoType: 'embed', videoSrc: 'https://www.youtube.com/embed/fnXzKwUgDhg?vq=hd1080&hd=1&rel=0', tag: 'trending', createdAt: 1747500015000 },
  { id: 'transformers-dark-of-moon-2011', title: 'Transformers: Dark of the Moon', category: 'movies', desc: 'Autobots menemukan pesawat luar angkasa Cybertronian yang tersembunyi di Bulan, memicu perlombaan dengan Decepticons untuk mencapainya terlebih dahulu dan mengungkap rahasianya yang dapat mengubah nasib Bumi selamanya.', genres: ['Action','Sci-Fi','Adventure'], rating: 6.3, year: 2011, duration: '2:31', quality: 'HD', streams: '1.1B+', image: 'https://image.tmdb.org/t/p/w500/28YlCLrFhONteYSs9hKjD1Km0Cj.jpg', backdrop: 'https://image.tmdb.org/t/p/original/h3js4rulxzKMOokM2oO5Kr0mBZU.jpg', videoType: 'embed', videoSrc: 'https://www.youtube.com/embed/EkqdO8dhptc?vq=hd1080&hd=1&rel=0', tag: 'featured', createdAt: 1747500016000 },

  // === 10 FILM KLASIK PUBLIC DOMAIN (Archive.org) ===
  { id: 'night-of-the-living-dead-1968', title: 'Night of the Living Dead', category: 'movies', desc: 'Sekelompok orang terjebak di sebuah rumah pertanian di Pennsylvania saat mayat hidup pemakan daging bangkit dari kubur. Film horor klasik karya George A. Romero yang menjadi cikal bakal genre zombie modern.', genres: ['Horror','Classic'], rating: 7.9, year: 1968, duration: '1:36', quality: 'HD', streams: '15M+', image: 'https://image.tmdb.org/t/p/w500/rb2NWyb008u1EcKCOyXs2Nmj0ra.jpg', backdrop: 'https://image.tmdb.org/t/p/original/5KtmBSqFtHY3I9t8lgH27Mc0bqY.jpg', videoType: 'embed', videoSrc: 'https://archive.org/embed/notld_201610', tag: 'trending', createdAt: 1747500017000 },

  { id: 'nosferatu-1922', title: 'Nosferatu', category: 'movies', desc: 'Adaptasi tidak resmi novel Dracula yang menceritakan Count Orlok, vampir mengerikan yang membawa wabah ke kota kecil. Mahakarya ekspresionisme Jerman karya F.W. Murnau.', genres: ['Horror','Fantasy','Classic'], rating: 7.9, year: 1922, duration: '1:34', quality: 'HD', streams: '12M+', image: 'https://image.tmdb.org/t/p/w500/zv7J85D8CC9qYagAEhPM63CIG6j.jpg', backdrop: 'https://image.tmdb.org/t/p/original/u06SympEEMb7pLhR9W3tvydHT9L.jpg', videoType: 'embed', videoSrc: 'https://archive.org/embed/Nosferatu1922', tag: 'new', createdAt: 1747500018000 },

  { id: 'the-general-1926', title: 'The General', category: 'movies', desc: 'Selama Perang Saudara Amerika, masinis Johnnie Gray berjuang merebut kembali lokomotif kesayangannya yang dicuri mata-mata Union beserta kekasihnya. Komedi bisu legendaris karya Buster Keaton.', genres: ['Comedy','Adventure','Classic'], rating: 8.1, year: 1926, duration: '1:18', quality: 'HD', streams: '8M+', image: 'https://image.tmdb.org/t/p/w500/nIp4gIXogCjfB1QABNsWwa9gSca.jpg', backdrop: 'https://image.tmdb.org/t/p/original/mzox4HbcV9W42MH2dB1QsdDVGo3.jpg', videoType: 'embed', videoSrc: 'https://archive.org/embed/the-general-1926-by-buster-keaton', tag: 'featured', createdAt: 1747500019000 },

  { id: 'phantom-of-opera-1925', title: 'The Phantom of the Opera', category: 'movies', desc: 'Seorang hantu cacat yang tinggal di bawah Gedung Opera Paris terobsesi pada penyanyi sopran muda dan menebar teror. Film bisu klasik dengan penampilan ikonik Lon Chaney.', genres: ['Horror','Drama','Classic'], rating: 7.5, year: 1925, duration: '1:33', quality: 'HD', streams: '6M+', image: 'https://image.tmdb.org/t/p/w500/mvaYpAYj957C2tlq3vVJPSzGJXK.jpg', backdrop: 'https://image.tmdb.org/t/p/original/6FSs7jMimg1PBYdhZtPNQhtKtEc.jpg', videoType: 'embed', videoSrc: 'https://archive.org/embed/the-phantom-of-the-opera.-1925.-original-version', tag: 'trending', createdAt: 1747500020000 },

  { id: 'detour-1945', title: 'Detour', category: 'movies', desc: 'Pianis sial Al Roberts menumpang ke California untuk menemui kekasihnya, namun terjerat dalam kematian misterius dan diperas oleh wanita licik. Film noir berbujet rendah karya Edgar G. Ulmer yang kini diakui sebagai mahakarya.', genres: ['Crime','Drama','Classic'], rating: 7.2, year: 1945, duration: '1:08', quality: 'HD', streams: '3M+', image: 'https://image.tmdb.org/t/p/w500/gJb9HRAs1V4bA0VKsWpT6mhv2RT.jpg', backdrop: 'https://image.tmdb.org/t/p/original/uGOKN4VeCsf249zypWfaAzfTxAB.jpg', videoType: 'embed', videoSrc: 'https://archive.org/embed/detour_ipod', tag: 'new', createdAt: 1747500021000 },

  { id: 'plan-9-from-outer-space-1959', title: 'Plan 9 from Outer Space', category: 'movies', desc: 'Alien membangkitkan mayat hidup dari kuburan San Fernando untuk melaksanakan rencana ke-9 mereka menguasai Bumi. Karya Ed Wood yang terkenal sebagai salah satu film terburuk sekaligus paling ikonik sepanjang masa.', genres: ['Sci-Fi','Horror','Classic'], rating: 4.1, year: 1959, duration: '1:19', quality: 'HD', streams: '5M+', image: 'https://image.tmdb.org/t/p/w500/bmicZi7PvlnZ9rZqp6QXN2Db0pT.jpg', backdrop: 'https://image.tmdb.org/t/p/original/9pHCAT1ScILdkhY8ErfOma8W4kB.jpg', videoType: 'embed', videoSrc: 'https://archive.org/embed/04d01e32-52e1-4321-bc84-f13c52701da6', tag: 'trending', createdAt: 1747500022000 },

  { id: 'caligari-1920', title: 'The Cabinet of Dr. Caligari', category: 'movies', desc: 'Dr. Caligari yang sinister memamerkan somnambulis Cesare di pekan raya, lalu serangkaian pembunuhan misterius pun terjadi. Tonggak ekspresionisme Jerman dengan desain visual yang dimiringkan dan mimpi buruk.', genres: ['Horror','Mystery','Classic'], rating: 8.0, year: 1920, duration: '1:18', quality: 'HD', streams: '4M+', image: 'https://image.tmdb.org/t/p/w500/myK9DeIsXWGKgUTZyGXg2IfFk0W.jpg', backdrop: 'https://image.tmdb.org/t/p/original/iNNNkYuUU365LhnPwQqfzBvKnsg.jpg', videoType: 'embed', videoSrc: 'https://archive.org/embed/the-cabinet-of-dr.-caligari-1920-by-robert-wiene', tag: 'featured', createdAt: 1747500023000 },

  { id: 'metropolis-1927', title: 'Metropolis', category: 'movies', desc: 'Di kota futuristik yang terbelah antara elit kaya dan pekerja tertindas, seorang pemuda berusaha menjembatani kedua dunia melalui cinta. Mahakarya sci-fi bisu karya Fritz Lang.', genres: ['Sci-Fi','Drama','Classic'], rating: 8.1, year: 1927, duration: '2:33', quality: 'HD', streams: '10M+', image: 'https://image.tmdb.org/t/p/w500/kr9wXRN23zLuWJIelahas1mtnYj.jpg', backdrop: 'https://image.tmdb.org/t/p/original/eeMoFKxjjiCi6iep2GEZtSAMYIr.jpg', videoType: 'embed', videoSrc: 'https://archive.org/embed/metropolis_202511', tag: 'featured', createdAt: 1747500024000 },

  { id: 'the-39-steps-1935', title: 'The 39 Steps', category: 'movies', desc: 'Richard Hannay terjerat dalam jaringan mata-mata setelah seorang wanita misterius terbunuh di apartemennya, lalu ia melarikan diri ke Skotlandia. Thriller espionase awal karya Alfred Hitchcock.', genres: ['Thriller','Mystery','Classic'], rating: 7.5, year: 1935, duration: '1:26', quality: 'HD', streams: '4M+', image: 'https://image.tmdb.org/t/p/w500/oC81jK6aAug4MA0xzYVngHmjsZS.jpg', backdrop: 'https://image.tmdb.org/t/p/original/zqLR4jm0lPFGnyN55QBSf4pzz5n.jpg', videoType: 'embed', videoSrc: 'https://archive.org/embed/the-39-steps-1935-zeberzee', tag: 'new', createdAt: 1747500025000 },

  { id: 'carnival-of-souls-1962', title: 'Carnival of Souls', category: 'movies', desc: 'Seorang wanita selamat dari kecelakaan mobil dan mulai melihat penampakan misterius yang menariknya menuju karnaval terbengkalai. Film horor independen kultus karya Herk Harvey.', genres: ['Horror','Mystery','Classic'], rating: 7.0, year: 1962, duration: '1:23', quality: 'HD', streams: '2M+', image: 'https://image.tmdb.org/t/p/w500/9ddPGH7kMe81xznwIKCt17VFUPi.jpg', backdrop: 'https://image.tmdb.org/t/p/original/esIoQw7VaykfHsw6fx2VltZ1R7U.jpg', videoType: 'embed', videoSrc: 'https://archive.org/embed/PhantasmagoriaTheater-CarnivalOfSouls1962592', tag: 'trending', createdAt: 1747500026000 },
